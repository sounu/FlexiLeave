...
<?php
	...
	$email=$_POST['email']; 
	$password=md5($_POST['password']); //(Message Digest Algorithm 5
	$gender=$_POST['gender']; 
	$dob=$_POST['dob']; 
								...
								<div class="row">
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="password" type="password" placeholder="strong pass" class="form-control" required="true" autocomplete="off">
										</div>
									</div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
